...
class OmsWalletEnvironment(
    ...
    fun indexerUrlForChainId(chainId: String): String =
        indexerUrlTemplate.replace("{value}", OmsWalletChains.chainNameFor(chainId))
    ...
    override fun toString(): String =
        "OmsWalletEnvironment(walletApiUrl=$walletApiUrl, apiRpcUrl=$apiRpcUrl, indexerUrlTemplate=$indexerUrlTemplate, authorizationScope=$authorizationScope)"
    ...
    companion object {
        ...
        fun demoDefaults(): OmsWalletEnvironment =
