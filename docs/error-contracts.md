...
| `client.wallet.startOidcRedirectAuth` | Local OIDC redirect-state persistence failure | `OmsStorageException`, `StorageError` | Retry starting OIDC auth after the local storage issue is resolved | Absent | `PublicErrorContractsTest` |
